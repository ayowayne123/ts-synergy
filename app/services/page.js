...
export const metadata = {
  ...
  <Image src={card.image} className="object-cover h-full w-full" alt={`${card.title}`} fill placeholder="blur" loading="lazy" />
        ...
        <div className="  flex flex-col  justify-between  h-full grow-0 lg:py-7 py-3">
          <p className="lg:text-xl md:text-lg  lg:pr-12 pb-5 md:pb-2">{card.description}</p>
...
<p className='font-light lg:text-2xl md:text-xl text-lg md:w-[690px] lg:w-[880px] sm:w-[400px] px-4 text-center'>We provide tailored financial services including tax consultation, accounting, financial planning, and business advisory. Experience our expertise and innovation to unlock your financial potential.</p>
