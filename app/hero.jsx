...
function Hero() {
  return ( 
    ...
    <div className="container font-light flex flex-col flex-grow justify-center  gap-5 lg:gap-4 pt-10 md:pt-20 xl:pt-24 lg:h-[calc(100vh_-_300px)] h-[calc(100dvh_-_150px)] md:h-[calc(100vh_-_218px)] min-h-[380px]">
