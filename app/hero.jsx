...
function Hero() {
  return ( 
    <div className="  flex flex-col jusify-between font-light overflow-hidden ">
        ...
        <div className="container px-8 font-light grid grid-cols-2 relative items-center  pt-10 md:pt-20 xl:pt-24 lg:h-[calc(100vh_-_100px)] h-[calc(100dvh_-_60px)] md:h-[calc(100vh_-_70px)] min-h-[380px] max-h-[1000px] ">
        <div>
        <h1 className="text-synergyBlue font-bold lg:max-w-[900px] max-w-[340px] md:max-w-[500px]
         lg:text-[64px] text-3xl md:text-5xl flex mx-auto text-left lg:mb-6 ">Empowering Financial Success Together</h1>
         <span className="py-2 lg:py-3 lg:max-w-[630px] max-w-[300px] md:max-w-[470px] flex mx-auto text-left lg:text-2xl md:text-lg text-sm leading-9 my-2">
         ...
         <div className="flex flex-row lg:pt-6 gap-4">
...
<div className="bg-synergyLightBlue lg:py-16 py-9 w-full ">
    ...
    <div className="container pt-6  lg:px-8">
        <div className=" flex flex-col items-center ">
           <div>
            <h2 className="text-synergyBlue font-semibold text-2xl lg:text-4xl text-center">Our Essence</h2>
            <p className="lg:max-w-[745px] text-center flex lg:text-xl mt-3 px-3 lg:px-0">Explore our tailored solutions driven by integrity and excellence, 
                empowering individuals and businesses to navigate finance with confidence.</p>
            </div> 
            
        </div>

        <div className="flex flex-col lg:grid grid-cols-2 lg:pt-12 lg:pr-6 px-3 lg:px-0 text-xl  gap-6 lg:gap-12">

        <div className="flex flex-col ">
<h3 className="text-xl lg:text-2xl font-semibold mb-7">Our Vision </h3>
<div className="border-b-[0.5px] border-synergyBlack w-full"></div>
<p className="text-sm lg:mt-7 lg:pr-3 md:text-base lg:text-lg">
...
<div className="flex flex-col ">
<h3 className="text-xl lg:text-2xl font-semibold mb-7">Our Mission  </h3>
<div className="border-b-[0.5px] border-synergyBlack w-full"></div>
<p className="text-sm lg:mt-7 lg:pr-3 md:text-base lg:text-lg">
...
<div className="  w-0 h-0 z-20  top-0
  border-b-[200px] 
   border-b-synergyBlue border-l-synergyLightBlue
  border-l-[100vw] "></div>
</div>
